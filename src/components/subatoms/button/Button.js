...
const Button = (props) => <StyledBtn id={props.id} onClick={props.action} size={props.size} color={props.color} width={props.width} height={props.height}>{props.text}</StyledBtn>;
